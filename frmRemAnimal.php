                ...
                <div class="row"><br>
                    <div class="col m8 s20 offset-m2 offset-s5 center white">
                        <h4 class="truncate bg-card-user">
                            ...
                            <div class="row login">
                                <h4>Deseja mesmo remover o animal?</h4>                            
                                <form action="insUser.php" id="frmInsUser" class="col s12">
                                    <div class="row">
                                        <button class="btn waves-effect waves-light red darken-3" type="button" id="btnExcluir" onclick="JavaScript:location.href='remAnimal.php?id=<?php echo $id?>'">
                                            Excluir
                                        </button>
